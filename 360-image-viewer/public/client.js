...
let textureArray=[];
let frontTexture=loader.load('./model/space/front.jpg');
let backTexture=loader.load('./model/space/back.jpg');
let bottomTexture=loader.load('./model/space/bottom.jpg');
let leftTexture=loader.load('./model/space/left.jpg');
let rightTexture=loader.load('./model/space/right.jpg');
let topTexture=loader.load('./model/space/top.jpg');
